...
jQuery(function($){
      ...
      $('.wysiwygeditor').froalaEditor({
        ...
        imageMaxSize: {$config['max_up_size']} * 1024,
		        ...
		        toolbarButtons: ['bold', 'italic', 'underline', 'strikeThrough', '|', 'align', 'indent', 'outdent',  '|', 'insertTable', 'insertHR',
		                         '|', 'insertLink',  '{$implugin}', 'insertVideo', 'dleaudio', 'dlemedia', '|', 'dlequote', 'dlespoiler', 'html', 'fullscreen'] }).on('froalaEditor.image.inserted froalaEditor.image.replaced', function (e, editor, \$img, response) {
