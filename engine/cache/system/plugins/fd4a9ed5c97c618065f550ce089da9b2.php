...
$claims_site_html = intval( $_POST['claims_site_html'] );
...
$claims_adm_text = $db->safesql( $_POST['claims_adm_text'] );
...
$db->query( "UPDATE " . PREFIX . "_email SET template='$claims_site_text', use_html='$claims_site_html' WHERE name='cl_site'" );
$db->query( "UPDATE " . PREFIX . "_email SET template='$claims_answer_text', use_html='$claims_answer_html' WHERE name='cl_ans'" );
$db->query( "UPDATE " . PREFIX . "_email SET template='$claims_adm_text', use_html='$claims_adm_html' WHERE name='cl_adm'" );
