                     ...
                     <div class="tab-pane active" id="tabhome">
						<div class="panel-body">
							...
							<div class="form-group">
							  <label class="control-label col-sm-2">Ma'lumot sarlavhasi</label>
							  <div class="col-sm-10">
							 ...
							 <div style="display: none;" class="form-group">
							  ...
							  <div class="col-sm-10">
								<input data-rel="calendar" type="text" name="newdate" class="form-control" style="width:190px;" autocomplete="off">
							  </div>
							</div>
							 ...
							 <div class="form-group">
							  ...
							  <div class="col-sm-10">
								<select data-placeholder="{$lang['addnews_cat_sel']}" title="{$lang['addnews_cat_sel']}" name="category[]" id="category" class="categoryselect" onchange="onCategoryChange(this)" $category_multiple style="width:100%;max-width:350px;">{$categories_list}</select>
							  </div>
							</div>
...
HTML;
	...
	if( $config['allow_admin_wysiwyg'] ) {
		...
		echo "<div class=\"editor-panel\"><div class=\"shadow-depth1\">{$bb_code}<textarea class=\"editor\" style=\"width:100%;height:600px;\" onfocus=\"setFieldName(this.name)\" name=\"short_story\" id=\"short_story\"></textarea></div></div>";
	}
...
HTML;
	...
	if( $user_group[$member_id['user_group']]['allow_main'] ) $main_input = "<div class=\"checkbox\" id=\"opt_holder_main\"><label><input class=\"icheck\" type=\"checkbox\" id=\"allow_main\" name=\"allow_main\" value=\"1\" checked>Bosh sahifada nashr etish</label></div>"; else $main_input = "";
							  ...
							  <div class="col-md-10">
								<div class="row">
									<div class="col-sm-6" style="max-width:300px;">
										<div style="display:none;" class="checkbox"><label><input class="icheck" type="checkbox" id="approve" name="approve" value="1" checked>{$lang['addnews_mod']}</label></div>
										{$main_input}
										<div style="display:none;" class="checkbox" id="opt_holder_rating"><label><input class="icheck" type="checkbox" id="allow_rating" name="allow_rating" value="1" checked>{$lang['addnews_allow_rate']}</label></div>
										{$fix_br}
									</div>
									<div class="col-sm-6">
										{$fix_input}
