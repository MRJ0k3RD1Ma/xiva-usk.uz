...
if ($value[1] == 'Русскый') {
	$nomi ='<img src="/engine/skins/images/ru.png" width="30" /> Русскый';
} elseif ($value[1] == 'English') {
	$nomi ='<img src="/engine/skins/images/eng.png" width="30" /> English';
} else {
	$nomi = $value[1];
}
$output .= <<<HTML
<div id="$holderid" class="form-group editor-group" {$uid}>
  <label class="control-label col-md-2">{$nomi}: [not-optional]<span style="color:red;">*</span>[/not-optional]{$value[18]}</label>
  <div class="col-md-10">
