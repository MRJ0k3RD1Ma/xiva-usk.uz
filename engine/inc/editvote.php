...
HTML;
	...
	if( $canedit == false ) {
		echo "<form class=\"form-horizontal\" method=\"post\" action=\"?mod=editvote&action=doadd\" name=\"addvote\" onsubmit=\"if(document.addvote.title.value == '' || document.addvote.body.value == ''){DLEalert('{$lang['vote_alert']}', 'Maydonlarni tekshiring');return false}\">";
		$button = "<input type=\"submit\" class=\"btn bg-teal btn-sm btn-raised\" value=\"So'rovnoma yaratish\">";
	} else {
		echo "<form class=\"form-horizontal\" method=\"post\" action=\"?mod=editvote&action=update&id={$id}\" name=\"addvote\" onsubmit=\"if(document.addvote.title.value == '' || document.addvote.body.value == ''){DLEalert('{$lang['vote_alert']}', 'Maydonlarni tekshiring');return false}\">";
		$button = "<input type=\"submit\" class=\"btn bg-teal btn-sm btn-raised\" value=\"So'rovnomani tahrirlash\">";
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		...
		<div class="form-group">
		  <label class="control-label col-md-2 col-sm-3">Savol</label>
		  <div class="col-md-10 col-sm-9">
			<input type="text" name="title" class="form-control width-500" value="{$title}">
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-md-2 col-sm-3">So'rovnoma boshlanish vaqti</label>
		  <div class="col-md-10 col-sm-9">
			<input data-rel="calendar" type="text" name="start_date" class="form-control" style="width:190px;" value="{$start_date}" autocomplete="off">
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-md-2 col-sm-3">So'rovnoma tugash vaqti</label>
		  <div class="col-md-10 col-sm-9">
			<input data-rel="calendar" type="text" name="end_date" class="form-control" style="width:190px;" value="{$end_date}" autocomplete="off">
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-md-2 col-sm-3">
			Javob variantlari<br />
			<span class="note large">Har bir yangi satr yangi<br /> javob hisoblanadi.</span></label>
		  <div class="col-md-10 col-sm-9">
