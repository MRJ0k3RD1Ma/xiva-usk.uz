...
echo <<<HTML
 <div class="table-responsive">
    <table class="table table-xs table-hover">
      <thead>
      <tr>
        <th><b>Ushbu manzilga kirganda</b></th>
        <th><b>Joriy manzilga yo'naltiriladi</b></th>
        <th style="width: 70px">Amallar</th>
...
<div class="panel-footer">
	<div class="pull-left"><button class="btn bg-teal btn-sm btn-raised" type="button" onclick="addLink()">Yangi manzilni qo'shish</button></div>

	<div class="pull-right">
	<select class="uniform position-left" name="action">
	<option value="">-- Amalni tanlash --</option>
...
<table width="100%">
    <tr>
        <td style="height:50px;"><div align="center"><br /><h5>Yo'naltirishlar kiritsangiz shu yerda nomoyon bo'ladi.</h<br></a></div></td>
    </tr>
</table>
</div>
<div class="panel-footer">
	<button class="btn bg-teal btn-sm btn-raised" type="button" onclick="addLink()">Yangi manzilni qo'shish</button>
</div>
...
<div class="alert alert-info alert-styled-left alert-arrow-left alert-component">Ushbu bo'limda siz bir sahifadan boshqasiga yo'naltirishlar yaratishingiz mumkin. Qayta yo'naltirish sizning saytingizdagi sahifadan boshqa URL manziliga yoki tashqi manbaga yo'naltirilishi mumkin. Shuningdek, siz URL-larni '*' belgisidan foydalangan holda guruhlashingiz mumkin, bu har qanday belgini qidirishni anglatadi, masalan  /page/1/, /page/2/, /page/xohlagan matn/ va h.k.</div>{$module_disabled}
...
<!--
	...
	function addLink() {
		...
		$("body").append("<div id='dlepopup' title='Manzil kiritish' style='display:none'>Joriy havoladan<br><input type='text' name='dle-promt-oldurl' id='dle-promt-oldurl' class='classic' style='width:100%;' value=''/><br><br>Joriy havolaga<br /><input type='text' name='dle-promt-newurl' id='dle-promt-newurl' class='classic' style='width:100%;' value=''/></div>");
...
$(function(){
		...
		$('.dellink').click(function(){
		    ...
		    DLEconfirm( 'Siz haqiqatdan ham ushbu: <b>&laquo;'+old_link+'&raquo;</b> manzilni olib tashlamoqchimisiz?', 'Manzilni olib tashlash', function () {
		...
		$('.editlink').click(function(){
			...
			$("body").append("<div id='dlepopup' title='Manzil kiritish' style='display:none'>Joriy havoladan<br><input type='text' name='dle-promt-oldurl' id='dle-promt-oldurl' class='classic' style='width:100%;' value='"+oldurl+"'/><br /><br />Joriy havolaga<br /><input type='text' name='dle-promt-newurl' id='dle-promt-newurl' class='classic' style='width:100%;' value='"+newurl+"'/></div>");
