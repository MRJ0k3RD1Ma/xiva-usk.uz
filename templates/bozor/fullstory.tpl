        ...
        <div role="navigation" aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs" itemprop="breadcrumb">
            <ul class="trail-items" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem" class="trail-item trail-begin">
                    <a href="/" rel="home" itemprop="item"><span itemprop="name">Bosh sahifa</span></a><meta itemprop="position" content="1" />
                </li>
                <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem" class="trail-item">
                    {link-category}
                </li>
                <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem" class="trail-item trail-end">
                    <span itemprop="item"><span itemprop="name">{title}</span></span><meta itemprop="position" content="5" />
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="inner-wrapper">
            <div id="primary" class="content-area">
                <main id="main" class="site-main" role="main">
                    <article id="post-123" class="post-123 post type-post status-publish format-standard has-post-thumbnail hentry category-recent-news">
                        <img src="{image-1}" style="width: 100%;" class="start-magazine-post-thumb aligncenter wp-post-image" />
                        <div class="article-wrapper">
                            <header class="entry-header">
                                <h1 class="entry-title">{title}</h1>
                                <div class="entry-meta">
                                    <span class="posted-on">
                                        <a href="{full-link}" rel="bookmark">
                                            <time class="entry-date published updated" datetime="2017-06-16T09:49:01+00:00">{date}</time>
                                        </a>
                                    </span>
                                    <span class="byline">
                                        <span class="author vcard">{title}</span>
                                    </span>
                                </div>
                                <!-- .entry-meta -->
                            </header>
