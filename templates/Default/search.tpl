<article class="box story searchpage">
	<div class="box_in">
		<h1 class="title">Saytdan qidirish</h1>
  ...
  <tr>
    <td class="search">
      <div style="margin:10px;">
                {searchfield}<br /><br />
                <input type="button" class="bbcodes" name="dosearch" id="dosearch" value="Izlash" onclick="javascript:list_submit(-1); return false;">
                <input type="button" class="bbcodes" name="dofullsearch" id="dofullsearch" value="Kengaytirilgan izlash" onclick="javascript:full_submit(1); return false;">
            </div>
