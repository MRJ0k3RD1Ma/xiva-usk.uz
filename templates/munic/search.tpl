<div class="search-page">
	<header class="sub-title"><h1><p>Saytdan ma'lumot izlash</p></h1></header>
	<br />
	<div class="searchtable" id="searchtable" name="searchtable">{searchtable}</div>
	[searchmsg]<div class="berrors clr"><b>Ma'lumotlar</b><br />{searchmsg}</div>[/searchmsg]
</div>
...
#fullsearch .options > div.switch label input:not(#rb_showposts_0):checked ~ span:before &#123;content: 'Xa';}
...
$("#searchinput").attr("placeholder","Saytdan izlash");
$("#dosearch").attr("value","Izlash");
$("#fullsearch").each(function(){
    ...
    if(id>0) {
        ...
        clear.attr('style','').attr('class','').attr('value','Yangilash').appendTo(b);
